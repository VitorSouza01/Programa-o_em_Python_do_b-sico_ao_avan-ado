...
- Conjuntos em qualquer linguagem de programação, estamos fazendo referência à Teoria dos Conjuntos da
Matemática.

"Teoria dos conjuntos ou de conjuntos é o ramo da lógica matemática que estuda conjuntos, que são coleções de elementos.
 Embora qualquer tipo de elemento possa ser reunido em um conjunto, a teoria dos conjuntos é, em geral,
 investigada com elementos que são relevantes para os fundamentos da matemática."
...
# Imagine que fizemos um formulário de cadastro de visitante em uma feita ou museu, e os visitantes
...
# Agora precisamos saber quantas cidades distintas, ou sejá, únicas, temos.
...
# Gerar um conjunto de estudantes que não estão n outro curso
