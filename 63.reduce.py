...
A partir do Python3+ a função reduce() não é mais uma função integrada (built-in). Agora temos que importar e utilizar esta função a partir do módulo “functools”.
...
Passo 2: res2 = f(res1, a3) # Aplica a função passando o resultado do passo1 mais o terceiro elementoe guarda o res.
...
Ou seja, em cada passo ele aplica a função passando como primeiro argumento e o resultado da aplicação anterior. No final, reduce() irá retornar o resultado final.
