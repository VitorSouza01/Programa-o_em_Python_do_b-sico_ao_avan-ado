...
Em linguagens de programação como o Java, ao declararmos atributos privados nas classes, contumamos a criar métodos públicos para manipulação desses atríbutos. Esses métodos são conhecidos por getters e setters onde os getters retornam o valor do atributo e os setters alteram o valor do mesmo.

Utilização do método Get e Set
