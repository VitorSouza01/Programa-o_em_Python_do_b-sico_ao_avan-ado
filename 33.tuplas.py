...
2 - As tuplas são imutáveis: Isso significa que ao ser criar uma tupla ela não muda.
...
# 1° CUIDADO: As tuplas são representadas por (), mas veja:
...
# O processo de criação de uma Tupla pode ser sem parênteses, porém sua representação é com parênteses!

# 2° CUIDADO: Tuplas com 1 elemento
...
# "Tupla aceita qualquer tipo de dado"
...
# * -> Se os valores forem todos inteiros ou reais podem;
...
# - Tuplas são mais rápidas do que listas. (Para operações)
