...
desde que começa com asterístico.

*xis - nome que pode ser dado
...
Obs: O asteristico serve para que informemos ao Python que estamos passando como argumento uma coleção
de dados. Deste forma, ele saberá que precisará antes desempacotar estes dados.
"""
